...
export const experiences = [
  // ✅ Work Experience
  {
    ...
    description: [
      "Worked across the full stack (Next.js, Express.js, Node.js, MongoDB, TypeScript, Vercel) to build and maintain multiple production-grade SaaS platforms. ",
      "Owned end-to-end feature delivery including architecture, schema design, development, testing, and deployments.",
      "Developed secure, scalable systems including custom multi-factor authentication, integration with third-party ecosystems and building internal boilerplates for efficiency and code quality across teams.",
      "Led and coordinated a team of 3 developers, managing project planning, task breakdown, execution, and end-to-end delivery for 12+ client projects.",
    ],
    icon: <FaUsersCog />,
  },
  {
